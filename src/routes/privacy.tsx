  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <article className="prose prose-neutral mx-auto max-w-3xl px-6 py-16">
        ...
        <p>
          This page describes the personal information Echo Your Influence ("we", operated by{" "}
          {OPERATOR}) collects, why we collect it, and the choices you have. This policy is
        ...
        <p>
          ...
          support@echoyourinfluence.app. If you are in the EEA, UK, or California, you have
          additional rights under GDPR/CCPA including the right to object, restrict processing, and
