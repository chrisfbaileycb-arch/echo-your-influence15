  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <article className="prose prose-neutral mx-auto max-w-3xl px-6 py-16">
        ...
        <p>
          The Starter Test Pass ($29.95/mo, 5 videos and 30 images) exists so you can evaluate Echo
          Your Influence at low cost before committing to a larger plan. You can upgrade, downgrade,
