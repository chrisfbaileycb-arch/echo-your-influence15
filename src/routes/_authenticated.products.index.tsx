...
export const Route = createFileRoute("/_authenticated/products/")({
  head: () => ({
    meta: [
      { title: "Products — Echo Your Influence" },
      {
        name: "description",
        content:
          "Every product you've added to Echo Your Influence, ready to turn into a 15-second affiliate video.",
      },
            ...
            return (
              ...
              >
                ...
                <Button
                  ...
                  className="absolute right-2 top-2 z-10 h-8 w-8 text-muted-foreground transition-colors hover:bg-destructive/10 hover:text-destructive"
                  onClick={(e) => {
                    e.preventDefault();
                    e.stopPropagation();
                    if (
