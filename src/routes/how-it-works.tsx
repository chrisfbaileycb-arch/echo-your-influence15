...
export const Route = createFileRoute("/how-it-works")({
  head: () => ({
    meta: [
      { title: "How Echo Your Influence works — Product URL to affiliate video in 60 seconds" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "How Echo Your Influence works" },
      {
      ...
      <section className="mx-auto max-w-4xl px-6 py-16 md:py-24">
        ...
        <div className="mt-16 rounded-2xl border border-border bg-surface p-8 text-center">
          ...
          <p className="mt-2 text-muted-foreground">
            Pick your pass and generate your first 15-second video — renders usually finish in about
            30–90 seconds.
          </p>
          <Link
            to="/auth"
