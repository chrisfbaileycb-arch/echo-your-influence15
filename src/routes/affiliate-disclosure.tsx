    ...
    <div className="min-h-screen bg-background">
      ...
      <article className="prose prose-neutral mx-auto max-w-3xl px-6 py-16">
        ...
        <p>
          ...
          <strong>you</strong> as a Echo Your Influence user are responsible for when publishing
          videos generated with our service.
        </p>

        <h2>1. Echo Your Influence's own affiliate relationships</h2>
        <p>
          {OPERATOR} (the operator of Echo Your Influence) may earn referral or affiliate
          ...
          price you pay, and we only recommend tools we actually use to build Echo Your Influence.
        </p>
        ...
        <ul>
          <li>
            <strong>Disclose the material connection</strong> in a way viewers can't miss. In the
            U.S., the FTC's Endorsement Guides require a clear disclosure such as <code>#ad</code>,{" "}
            <code>#sponsored</code>, or "paid partnership" placed <em>before</em> viewers have to
            expand the caption or scroll.
          </li>
          <li>
            <strong>Use each platform's built-in disclosure tools</strong> when they exist —
            TikTok's "Paid partnership" toggle, Instagram's branded content tag, YouTube's "Includes
          ...
          <li>
            ...
            realistic-looking people or scenes. Echo Your Influence videos meet that bar — always
            toggle the platform's AI content label on.
          </li>
          <li>
            <strong>Comply with each affiliate network's terms</strong> — Amazon Associates
            specifically requires the disclosure to appear on the platform where the link is shared,
            not only on the destination page.
          </li>
          <li>
            <strong>Not make earnings claims or product claims you can't substantiate.</strong> Do
            not imply that generated influencer personas are real users of the product.
          </li>
        </ul>

        <h2>3. Suggested disclosure copy</h2>
        <p>
          For TikTok, Reels, and Shorts captions we recommend appending, in addition to the
          platform's paid-partnership toggle:
        </p>
        <blockquote>
        ...
        <p>
          The creators who appear in Echo Your Influence videos are AI avatars, not real endorsers.
          You may not present them as real customers or real professionals (doctors, dentists,
          lawyers, financial advisors, etc.) making claims about a product.
        </p>
