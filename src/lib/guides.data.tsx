  ...
  "tiktok-shop-affiliate": {
    ...
    body: (
      <>
        ...
        <p>
          The traditional bottleneck has always been production time. This playbook details how Echo
          Your Influence's multi-engine creative studio shortens that bottleneck by turning a single
          URL into a full media kit without a camera, a studio, or an editor.
        </p>
        ...
        <p>
          ...
          Paste it into Echo Your Influence. Our extraction engine automatically pulls the title,
          key value propositions, price, and high-res media assets into a unified creative brief.
        </p>

        <h2>3. Choose your media pipeline &amp; engines</h2>
        <p>
          Echo Your Influence gives you a multi-engine studio to generate both video and static
          assets in one pass:
        </p>
        <ul>
          <li>
        ...
        <ul>
          ...
          <li>
            Grab your MiniMax silent b-roll clips for sleek visual cuts or background overlays.
          </li>
          <li>
        ...
        <p>
          Attach your click-tracked affiliate or campaign link from Echo Your Influence's Link
          Manager and post. A steady daily posting habit beats one big batch — pick a cadence you
          can keep.
        </p>
