...
export interface Industry {
  ...
  headline: string;
  description: string;
  /** Itemized list of specific sub-careers */
  subCareers: string[];
  /** Avatar bg gradient/color */
...
export const INDUSTRIES: Industry[] = [
  {
    ...
    description:
      "Paste a listing link and get an agent-avatar walkthrough short plus the Just Listed and Just Sold cards your feed needs.",
    subCareers: [
      "Realtors",
      "Listing Agents",
      "Property Managers",
  ...
  },
  {
    ...
    avatarBg: "bg-indigo-50 text-indigo-600 border-indigo-200",
  ...
  },
  {
    ...
    subCareers: ["Pizza Shops", "Bakery & Cafes", "Fine Dining", "Food Trucks", "Bars & Lounges"],
