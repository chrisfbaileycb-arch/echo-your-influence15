    ...
    <footer className="border-t border-border">
      <div className="mx-auto max-w-6xl px-6 py-12">
        ...
        <p className="mb-8 rounded-xl glass px-4 py-3 text-xs text-muted-foreground">
          ...
          Echo Your Influence video that promotes a product for commission, you must disclose the
          paid relationship (e.g. <code>#ad</code>) and toggle each platform&apos;s AI-content
          label. See our{" "}
        ...
        <div className="flex flex-col gap-10 md:flex-row md:items-start md:justify-between">
          ...
          <div className="max-w-xs">
            <Link
              ...
              aria-label="Echo Your Influence home"
            >
              <BrandMark />
